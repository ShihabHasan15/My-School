            ...
            public void onClick(View v) {
                ...
                if (t_full_name.isBlank() || t_email.isBlank() || t_password.isBlank() || t_mobile_number.isBlank()
                    ...
                    if (!Patterns.EMAIL_ADDRESS.matcher(t_email).matches()) {
                        ...
                        String url = "http://192.168.0.106/Apps/teacher_data.php?id=" + t_id + "&name=" + t_full_name + "&email=" + t_email + "&password=" + t_password + "&mb_number=" + t_mobile_number + "&department=" + t_department;
