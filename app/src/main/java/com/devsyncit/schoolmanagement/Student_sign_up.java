                ...
                || s_class.isBlank() || s_roll.isBlank()){
                    ...
                    if (!Patterns.EMAIL_ADDRESS.matcher(s_email).matches()){
                        ...
                        if (s_int_class>0 && s_int_class<=10){
                            ...
                            String url = "http://192.168.0.101/Apps/student_data.php?roll="+s_roll+"&name="+s_full_name+"&email="+s_email+"&password="+s_password+"&mb_number="+s_mobile_number+"&class="+s_class;
